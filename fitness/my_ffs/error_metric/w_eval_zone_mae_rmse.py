...
train_absolute = "C:\\Users\\asolm\\Documents\\NaturalComputationProject\\PonyGE2\\datasets\\Glucose\\540\\540-ws-training.csv"
train_absolute_2nd = "C:\\Users\\asolm\\Documents\\NaturalComputationProject\\PonyGE2\\datasets\\Glucose\\596\\596-ws-training.csv"
...
def calculate_final_fitness(eval_zone, ground_truth, guesses):
    mae = mean_absolute_error(ground_truth, guesses)
    rmse = mean_squared_error(ground_truth, guesses, squared=False)
    return rmse + mae + eval_zone


class w_eval_zone_mae_rmse(base_ff):
    def __init__(self):
    ...
    def evaluate(self, ind, **kwargs):
        ...
        for x in range(file.shape[0]):
            ...
            try:
                ...
                print("SONO NELL'ECCEZIONE Questa, male")
